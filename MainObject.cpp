    ...
    if (events.type == SDL_MOUSEBUTTONDOWN)
    {
        ...
        else if (events.button.button == SDL_BUTTON_LEFT)
        {
            ...
            else
            {
                ...
                p_bullet->SetRect(this->rect_.x + width_frame_- 20, rect_.y + height_frame_*0.10);
            }
...
void MainObject::UpdateImagePlayer(SDL_Renderer* des)
{
    if (on_ground_ == true)
    {
        if(status_ == WALK_LEFT)
        {
            LoadImg("nv//player_left.png", des);
        }
        else
        {
            LoadImg("nv//player_right.png", des);
        }
    }
    else
    {
        if (status_ == WALK_LEFT)
        {
            LoadImg("nv//jum_left.png", des);
        }
        else
        {
            LoadImg("nv//jum_right.png", des);
        }
    }
}